...
# Path of the stream intake
ENV STREAM_LOCATION="/live/stream"
...
RUN git clone https://github.com/mvarhola/comfy-channel.git /comfy-channel
...
CMD python -u src/ComfyChannel.py -o "rtmp://"${SERVER_IP}${STREAM_LOCATION}